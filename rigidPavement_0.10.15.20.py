...
csv_file_path = "output_table_0.10.15.20.csv"
...
def generatePlots():
    ...
    pdf_filename = "plots_0.10.15.20.pdf"
        ...
        for axle_type in axle_types:
            for shoulder in shoulders:
                for p in p_values_dict[axle_type]:
                    ...
                    # Save the 2x2 subplot figure to the PDF file
                    pdf.savefig()
                    plt.close()
